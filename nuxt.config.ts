...
export default defineNuxtConfig({
  ...
  routeRules: {
    '/cbb': { redirect: '/wcbb-games' },
    '/nfldecision': { redirect: '/draft-sim' },
    '/nflrtm': { redirect: '/draft-sim' },
    '/nba': { redirect: '/' },
    '/nfl': { redirect: '/draft-sim' },
    '/apps': { redirect: '/' },
    '/cfb': { redirect: '/draft-sim' },
    '/cfblines': { redirect: '/draft-sim' },
    '/cfblines+': { redirect: '/draft-sim' },
    '/nbalines': { redirect: '/' },
    '/nbalines+': { redirect: '/' },
    '/nfllines': { redirect: '/draft-sim' },
    '/nfllines+': { redirect: '/draft-sim' },
    '/cfb4thdown': { redirect: '/draft-sim' },
    '/cfbpredictor': { redirect: '/draft-sim' },
    '/livecfbepa': { redirect: '/draft-sim' },
    '/livemlb': { redirect: '/' },
    '/mlbwpa': { redirect: '/' },
    '/nflfpi+': { redirect: '/draft-sim' },
    '/nflpredictor': { redirect: '/draft-sim' },
    '/playstation': { redirect: '/draft-sim' },
    '/wnba': { redirect: '/' },
    '/soccer': { redirect: '/' },
    ...
    '/mcbb-title': { redirect: '/mcbb-all' },
    '/wcbb-title': { redirect: '/wcbb-all' },
    '/mcbbGames': { redirect: '/mcbb-games' },
    '/wcbbGames': { redirect: '/wcbb-games' },
    '/mcbbAll': { redirect: '/mcbb-all' },
    '/wcbbAll': { redirect: '/wcbb-all' }
  },
})