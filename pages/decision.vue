<template>
  <Head>
    ...
    <div class="relative min-h-screen bg-espngray-100 ">
      ...
      <div class="flex flex-wrap justify-center gap-10 p-10 pt-28 font-medium text-3xl text-espnblack text-center">Decision Analysis page is undergoing a backend update. Be back soon!</div>
    </div>
  </template>
