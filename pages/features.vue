            ...
            <div class="mx-auto max-w-2xl text-center">
              ...
              <div class="mt-10 flex items-center justify-center gap-x-6 flex-wrap">
                <div class="flex gap-x-1 gap-y-4 sm:gap-6 flex-wrap justify-center">
                  <a href="https://espnanalytics.com/draft-sim" class="w-[162px] rounded-md bg-espncyan-200 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-espncyan-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-espncyan-900">NFL Draft Simulator</a>
                  <a href="https://espnanalytics.com/draft-predictor" class="w-[162px] rounded-md bg-espncyan-200 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-espncyan-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-espncyan-900">NFL Draft Predictor</a>
