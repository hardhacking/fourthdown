<template>
  <Head>
    ...
    <Meta property="og:url" content="https://www.espnanalytics.com/wcbb-games" />
    <Meta name="twitter:url" content="https://www.espnanalytics.com/wcbb-games" />
  ...
  * {
  ...
  export default {
    ...
    methods: {
      async loadPage() {
        this.data = await this.getS3Data('old_womens-college-basketball.json');
      ...
      setZoomLevel() {
        ...
        //   document.getElementById('pagerr_game-id').style.zoom = '0.6';
        } else {
          document.getElementById('page-id').style.zoom = '0.7';
        }
      },
